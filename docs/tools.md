...
The TiAs use a deliberately small software stack. You do not need to master every library before starting: follow the notebook explanations and consult these references when a construct is unfamiliar.
...
- **scikit-learn** — provides small packaged datasets, baseline estimators, preprocessing and metrics. Read [Getting started](https://scikit-learn.org/stable/getting_started.html) and the [model evaluation guide](https://scikit-learn.org/stable/modules/model_evaluation.html).
- **PyTorch** — used sparingly for automatic differentiation and small neural networks. Work through [Learn the basics](https://docs.pytorch.org/tutorials/beginner/basics/intro.html); the most relevant sections are tensors, automatic differentiation, model building and optimisation.
